    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open} >
        ...
        <List>
          ...
          }} onClick={() => { navigate("/AcceuilAdmin"); setSelectedItem('DashBoard') }}>
            <ListItemButton
              sx={{
                minHeight: 48,
          ...
          <ListItem disablePadding sx={{
            display: 'block',
            backgroundColor: selectedItem === 'Professeur' ? theme.palette.grey[300] : 'transparent',
          }} onClick={() => { navigate("/professeur"); setSelectedItem('Professeur') }}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
          ...
          <ListItem disablePadding sx={{
            display: 'block',
            backgroundColor: selectedItem === 'Matiere' ? theme.palette.grey[300] : 'transparent',
          }}
            onClick={() => { navigate("/matiere"); setSelectedItem('Matiere') }}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
            ...
            >
              ...
              <ListItemText primary="Matieres" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
          <ListItem disablePadding sx={{
            display: 'block',
            ...
            >
              ...
              <ListItemText primary="Cahier" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
          ...
          <ListItem disablePadding sx={{
            ...
            onClick={() => { navigate("/promotion"); setSelectedItem('Promotion') }}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
            ...
            >
              ...
              <ListItemText primary="Promotion" sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
                
          <ListItem disablePadding sx={{
            display: 'block',
            backgroundColor: selectedItem === 'Utilisateur' ? theme.palette.grey[300] : 'transparent',
          }}
            onClick={() => { navigate("/utilisateur"); setSelectedItem('Promotion') }}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
